            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center p-4">
                        <img class="image-fluid border rounded-circle w-75 p-2 mb-4" src="${pageContext.request.contextPath}/resources/img/team-1.jpg" alt="">
                        <div class="team-text">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item text-center p-4">
                        <img class="image-fluid border rounded-circle w-75 p-2 mb-4" src="${pageContext.request.contextPath}/resources/img/team-2.jpg" alt="">
                        <div class="team-text">
                            <div class="team-title">
                                <h5>Full Name</h5>
