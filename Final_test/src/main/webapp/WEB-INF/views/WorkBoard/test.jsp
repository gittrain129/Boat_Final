...
<html>
<head>
	<title>Quos ut recusandae et consequuntur.</title>
	
	<link rel="stylesheet" type="text/css" href="public/lib/fa-5/css/all.css" />
	
	<link rel="stylesheet" type="text/css" href="public/lib/bootstrap-4/css/bootstrap.min.css" />
</head>
<body>
	...
	<div class="row">
		...
		<h3>Quos ut recusandae et consequuntur.</h3>
...
<script type="text/javascript" src="public/lib/sceditor/minified/sceditor.min.js"></script>
<script type="text/javascript" src="public/lib/sceditor/minified/formats/bbcode.js"></script>
<script>
...
sceditor.create(textarea, {
	...
	<script type="text/javascript" src="public/lib/bootstrap-4/js/bootstrap.min.js"></script>
	
	<script type="text/javascript" src="public/lib/bootstrap-4/js/popper.min.js"></script>
</body>
</html>