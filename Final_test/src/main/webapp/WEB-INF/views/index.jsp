        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <img class="image-fluid rounded" src="image/project-1.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="image-fluid rounded" src="image/project-2.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="image-fluid rounded" src="image/project-3.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="image-fluid rounded" src="image/project-4.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="image-fluid rounded" src="image/project-5.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="image-fluid rounded" src="image/project-6.jpg" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
