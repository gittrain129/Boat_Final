...
<head> 
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/filebo/filelist.css">
...
<%--moment lib --%>
	...
	<script src="${pageContext.request.contextPath}/resources/js/filelist.js"></script>
